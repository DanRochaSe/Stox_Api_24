...
namespace API.Utility
{
    public static class SqlHelper
    {
        ...
        public static bool ExecuteProcedureNonQuery(string connString, string procName,
           List<SqlParameter> paramters)
        {
            bool result = false;
            using (var sqlConnection = new SqlConnection(connString))
            {
        ...
        public static DataTable GetTableFromSP(string connString, string sp, SqlParameter[] prms)
        {
